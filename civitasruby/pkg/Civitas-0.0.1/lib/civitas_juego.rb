...
class CivitasJuego
  ...
  def inicializa_tablero(mazo)
    ...
    @tablero.anade_casilla(CasillaCalle.new("San Xenxo",TituloPropiedad.new("San Xenxo",80,1.20,610,880,200)))
    @tablero.anade_casilla(CasillaSorpresa.new("¡Sorpresaaaa!",@mazo))
    @tablero.anade_juez
    @tablero.anade_casilla(CasillaCalle.new("Torre de Hercules",TituloPropiedad.new("Torre de Hercules",70,1.20,590,840,185)))
    @tablero.anade_casilla(CasillaCalle.new("Matadero",TituloPropiedad.new("Matadero",60,1.17,565,800,170)))
    @tablero.anade_casilla(CasillaSorpresa.new("¡Sorpresaaaa!",@mazo))
    
    @tablero.anade_casilla(CasillaCalle.new("Los Rosales",TituloPropiedad.new("Los Rosales",110,1.29,680,1150,240)))
    @tablero.anade_casilla(CasillaCalle.new("Orzan",TituloPropiedad.new("Orzan",100,1.26,650,950,230)))
    @tablero.anade_casilla(Casilla.new("Descanso"))
    @tablero.anade_casilla(CasillaCalle.new("Riazor",TituloPropiedad.new("Riazor",90,1.23,630,920,215)))
    @tablero.anade_casilla(CasillaSorpresa.new("¡Sorpresaaaa!",@mazo))
    @tablero.anade_casilla(CasillaCalle.new("Calle Monte Alto",TituloPropiedad.new("Calle Monte Alto",170,1.44,830,1650,310)))
    @tablero.anade_casilla(CasillaCalle.new("Mesoiro",TituloPropiedad.new("Mesoiro",140,1.37,770,1500,280)))
    
    @tablero.anade_casilla(CasillaCalle.new("Cuatro Caminos",TituloPropiedad.new("Cuatro Caminos",130,1.34,740,1300,270)))
    @tablero.anade_casilla(CasillaSorpresa.new("¡Sorpresaaaa!",@mazo))
    @tablero.anade_casilla(CasillaCalle.new("Calle Medio Ambiente",TituloPropiedad.new("Calle Medio Ambiente",210,1.53,950,2200,360)))
    @tablero.anade_casilla(CasillaCalle.new("Calle Margarita Xirgú",TituloPropiedad.new("Calle Margarita Xirgú",200,1.5,920,2000,350)))
    @tablero.anade_casilla(CasillaImpuesto.new("Multa por mamadisimo",1000))
    @tablero.anade_casilla(CasillaCalle.new("Calle Ferrol",TituloPropiedad.new("Calle Ferrol",180,1.45,860,1850,320)))
  ...
  def inicializa_mazo_sorpresas(tablero)
    ...
    @mazo.al_mazo(SorpresaPagarCobrar.new("Cobra 500 euros porque eres el mejor",+500))
    @mazo.al_mazo(SorpresaPagarCobrar.new("Pagas 500 euros por exceso de velocidad",-500))
    @mazo.al_mazo(SorpresaIrCasilla.new("Avanza hasta la casilla Salida", tablero, 0))
    @mazo.al_mazo(SorpresaIrCasilla.new("Vas a la carcel por chulo", tablero, 4))
