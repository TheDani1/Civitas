...
class GestorEstados {
  ...
  EstadosJuego siguienteEstado (Jugador jugador, EstadosJuego estado,
    ...
    Diario.getInstance().ocurreEvento("De: "+estado.toString()+ " con "+
            operacion.toString()+ " sale: "+siguiente.toString());
